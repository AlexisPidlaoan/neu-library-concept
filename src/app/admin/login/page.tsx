    ...
    <div className="min-h-screen flex items-center justify-center p-4 bg-slate-50">
      <Card className="w-full max-w-md border-none shadow-2xl">
        <CardHeader className="text-center pb-2 relative">
          ...
          <CardTitle className="text-2xl font-bold text-primary">Library Admin</CardTitle>
        ...
        <CardContent className="space-y-6 p-8">
          <div className="space-y-4">
            ...
            <div className="relative">
              ...
              <div className="relative flex justify-center text-xs uppercase"><span className="bg-white px-2 text-muted-foreground">Or password access</span></div>
            </div>
